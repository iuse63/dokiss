...
function getCateUrl(URL) {
    if (URL.includes("apptov5/v1") || URL.includes("apptov5")) {
...
function getRecommendUrl(URL) {
    if (URL.includes("apptov5/v1") || URL.includes("apptov5/v1")) {
...
function getFilterTypes(URL, typeExtend) {
    ...
    } else if (URL.includes("apptov5/v1") || URL.includes("apptov5/v1")) {
...
function getSearchUrl(URL, KEY) {
    ...
    } else if (URL.includes("apptov5/v1") || URL.includes("apptov5")) {
